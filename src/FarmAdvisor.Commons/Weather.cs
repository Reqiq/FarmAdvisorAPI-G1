...
namespace FarmAdvisor.Business
{
    ...
    public partial class WeatherForecast
    {
        public static WeatherForecast FromJson(string json) => JsonConvert.DeserializeObject<WeatherForecast>(json, FarmAdvisor.Business.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this WeatherForecast self) => JsonConvert.SerializeObject(self, FarmAdvisor.Business.Converter.Settings);
    }
